#!/usr/bin/env python3
"""
Script para inicializar banco de dados PostgreSQL com schema completo.
Executa automaticamente na primeira inicialização do Web Service.
"""
import os
import psycopg2
from psycopg2 import sql

# Schema PostgreSQL (convertido do SQLite)
POSTGRES_SCHEMA = """
...
CREATE TABLE IF NOT EXISTS campaign_budget_config (
    id SERIAL PRIMARY KEY,
    campaign_id INTEGER NOT NULL,
    is_daily_budget BOOLEAN DEFAULT TRUE,
...
-- Velyra Actions (para sistema de aprovação)
...
-- Spend Authorizations (para sistema de aprovação de gastos)
